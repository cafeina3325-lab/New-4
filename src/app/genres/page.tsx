        ...
        <div className="container mx-auto px-6 max-w-6xl">
            ...
            <div className="animate-fade-in space-y-12">
                ...
                <div className="glass-panel p-8 md:p-12 rounded-3xl text-center border-white/10">
                    ...
                    <p className="text-lg text-gray-300 leading-loose max-w-3xl mx-auto word-keep-all break-keep">
                        {currentGenre.desc}
                    </p>
                </div>
                    ...
                    {currentGenre.features.map((feature, idx) => (
                        <div key={idx} className="flex justify-center">
                            ...
                            >
                                ...
                                <p className="text-gray-300 font-medium word-keep-all leading-tight relative z-10 group-hover:text-white transition-colors break-keep">
                                    {feature}
                                </p>
                            </div>
                        </div>
                        ...
                        {currentGenre.details.map((section, idx) => (
                            <div key={idx} className="glass-panel p-8 rounded-2xl border-white/5 hover:border-white/20 transition-colors">
                                ...
                                <div className="space-y-6">
                                    {section.text && (
                                        <p className="text-gray-300 leading-relaxed word-keep-all break-keep">{section.text}</p>
                                    )}
                                        ...
                                        <div className="grid gap-6">
                                            {section.items.map((item, itemIdx) => (
                                                <div key={itemIdx}>
                                                    ...
                                                    <p className="text-gray-400 leading-relaxed word-keep-all break-keep">
                                                        {item.text}
                                                    </p>
                                                </div>
                                            ))}
                                        ...
                                        <ul className="grid gap-4">
                                            {section.list.map((item, listIdx) => (
                                                <li key={listIdx} className="flex flex-col md:flex-row gap-2 md:gap-4 p-4 rounded-lg bg-white/5 border border-white/5">
                                                    ...
                                                    <span className="text-gray-400 break-keep">{item.desc}</span>
                                                </li>
                                            ))}
                                        </ul>
                                    )}
