    ...
    return (
        <section className="min-h-screen flex flex-col justify-center py-20 bg-transparent w-full relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <h2 className="text-5xl md:text-6xl xl:text-[5.625rem] font-bold text-center mb-20 text-white">Genres</h2>
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="absolute inset-0 flex items-center justify-center p-4 z-20">
                                    <span
                                        className="text-base md:text-lg font-bold tracking-[0.14em] text-white 
