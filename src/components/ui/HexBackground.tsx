...
export default function HexBackground() {
            ...
            const glowMat = new THREE.ShaderMaterial({
                ...
                fragmentShader: `
                    ...
                    void main() {
                        ...
                        vec3 skyBlueList = vec3(0.0, 1.0, 1.8); 
                        float flowIntensity = smoothWave * 1.2; 
    ...
    return (
        <div
            ref={mountRef}
            className="fixed top-0 left-0 w-full h-full pb-0 mb-0 -z-10 bg-[#030A14] overflow-hidden"
