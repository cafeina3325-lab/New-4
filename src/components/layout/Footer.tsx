...
export default function Footer() {
    ...
    return (
        <footer className="bg-[#1C1310] text-gray-400 py-16 border-t border-white/5">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    {/* 1. Left Column: Brand & Social & Contact */}
                    <div className="space-y-6">
                        <h2 className="text-2xl font-bold text-[#D6C7B5] tracking-tight">Flying Studio</h2>
                        ...
                        <button
                            ...
                            className="px-6 py-2 bg-[#B69676] hover:bg-[#A68666] text-[#1C1310] font-bold rounded-lg transition-all shadow-md"
                        >
                            Contact Us
                        </button>
                    </div>
                    ...
                    <div>
                        <h3 className="text-[#D6C7B5] font-bold mb-4 uppercase text-sm tracking-wider">Menu</h3>
                    ...
                    <div className="lg:col-span-2 flex flex-col lg:items-end text-sm leading-relaxed">
                        <div className="text-left">
                            <h3 className="text-[#D6C7B5] font-bold mb-4 uppercase text-sm tracking-wider">Information</h3>
                            <div className="flex flex-col space-y-2 text-gray-400 break-keep">
                                <p><span className="font-bold text-[#A89B8C] mr-2">OWNER</span> Hong Gil Dong</p>
                                <p><span className="font-bold text-[#A89B8C] mr-2">LICENSE</span> 123-45-67890</p>
                                <p><span className="font-bold text-[#A89B8C] mr-2">MANAGER</span> Kim Cheol Su</p>
                                <p><span className="font-bold text-[#A89B8C] mr-2">ADDRESS</span> Incheon, Namdong-gu, Guwol-dong 1234-5, 2F</p>
                                <p><span className="font-bold text-[#A89B8C] mr-2">HOURS</span> 11:00 - 20:00 (Mon - Sat)</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {/* Bottom: Copyright */}
                <div className="border-t border-white/5 pt-8 text-center text-sm text-[#A89B8C]">
