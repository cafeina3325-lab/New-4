        ...
        <>
            <nav
                ...
                className={`
                    ...
                    overflow-y-auto lg:overflow-y-visible scrollbar-hide
                ...
                <div className={`relative z-10 flex flex-col lg:flex-row items-start lg:items-center w-full lg:w-auto ${showNavBar ? 'opacity-100' : 'opacity-0'} transition-opacity duration-300`}>
                        ...
                        {menuItems.map((item) => (
                            <li key={item.name} className="relative group lg:h-full flex flex-col lg:flex-row lg:items-center item-start w-full lg:w-auto">
                                <div className="flex items-center justify-between w-full lg:w-auto">
                                    <Link
                                        href={item.path}
                                        className="text-base lg:text-lg font-medium text-[#A89B8C] hover:text-white transition-colors py-2 lg:py-4 block w-full lg:w-auto"
                                        onClick={(e) => {
                                            ...
                                            <ul className="py-2">
                                                {item.subItems.map((subItem) => (
                                                    <li key={subItem.name}>
                                                        <Link
                                                            href={subItem.path}
                                                            className="block px-4 lg:px-6 py-2 lg:py-3 text-sm text-[#D4B483] hover:bg-white/10 hover:text-white transition-colors whitespace-nowrap"
                    ...
                    <div className="mt-8 lg:mt-0 w-full lg:w-auto flex justify-center lg:block">
                        <button
                            ...
                            className="px-9 py-3.5 lg:px-6 lg:py-2 bg-[#B69676] hover:bg-[#A68666] text-[#1C1310] font-bold rounded-lg transition-all w-auto lg:w-auto lg:mr-4 backdrop-blur-sm shadow-lg"
                        >
                            Contact
                        </button>
                    </div>
